...
✨ *VINCULACIÓN TEMPORAL POR QR*

Escanea este código QR para activar tu sesión secundaria como Sub-Bot de manera rápida y segura.

📖 *Pasos a seguir:*
1️⃣ Abre WhatsApp en tu dispositivo principal.
2️⃣ Dirígete a *Dispositivos vinculados*.
3️⃣ Selecciona *Vincular un dispositivo* y escanea.

⏳ *El código expira en 45 segundos.*
🛸 _¡Nox Bot a tu servicio en la oscuridad!_`;

let rtx2 = `🌌 ───「 𝐍𝐎𝐗 𝐁𝐎𝐓 - 𝐂𝐎́𝐃𝐈𝐆𝐎 」─── 🌌

✨ *VINCULACIÓN TEMPORAL POR CÓDIGO*

Utiliza el siguiente código de 8 dígitos para iniciar sesión de manera remota.

📖 *Pasos a seguir:*
1️⃣ Ve a *Dispositivos vinculados* en tu WhatsApp.
2️⃣ Elige *Vincular con el número de teléfono*.
3️⃣ Introduce el código de 8 dígitos generado abajo.

⚠️ *Nota:* Si tienes otra sesión activa, ciérrala previamente para evitar conflictos.`;
